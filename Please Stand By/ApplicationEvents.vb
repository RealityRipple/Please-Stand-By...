Namespace My
  Partial Friend Class MyApplication
    ...
    Private Sub MyApplication_Startup(ByVal sender As Object, ByVal e As Microsoft.VisualBasic.ApplicationServices.StartupEventArgs) Handles Me.Startup
      ...
      End If
    End Sub
    Private Sub sia_NewInstanceStartup(sender As Object, e As Microsoft.VisualBasic.ApplicationServices.StartupNextInstanceEventArgs) Handles sia.NewInstanceStartup
      If e.CommandLine IsNot Nothing AndAlso e.CommandLine.Count > 0 Then
        If e.CommandLine.Contains("/uninstall") OrElse e.CommandLine.Contains("-uninstall") Then
          cSettings.RemoveAll()
  ...
  Friend Class SingleInstance
    ...
    Public Sub New(Optional ByVal sMain As String = Nothing)
      mutex = Nothing
      pipe = Nothing
